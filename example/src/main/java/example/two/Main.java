...
public class Main {
  static List<RemoteServer> getRemoteServers() {
    return List.<RemoteServer> of(new RemoteServer("EAN", new Project("PLUG"), new Project("PLUGDEV")), new RemoteServer("JAC", new Project("CONF"),
      new Project("CONFDEV")), new RemoteServer("JDOG", new Project("FECRU"), new Project("JDEV")));
  }
  ...
  public static List<Project> fetchAllProjects() {
    ...
    final Function<Future<Error<List<Project>>>, List<Project>> getOk = new Function<Future<Error<List<Project>>>, List<Project>>() {
